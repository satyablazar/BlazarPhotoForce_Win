...
namespace PhotoForce
{
    ...
    public partial class App : Application, INotifyPropertyChanged
    {
        ...
        bool _isAddEquipmentItemsButtonVisible;
        bool _isClearStudentsVisible;
        bool _isDuplicatePhotoShootsButtonVisible;

        public bool isDuplicatePhotoShootsButtonVisible
        {
            get { return _isDuplicatePhotoShootsButtonVisible; }
            set { _isDuplicatePhotoShootsButtonVisible = value; NotifyPropertyChanged("isDuplicatePhotoShootsButtonVisible"); }
        }
        public bool isClearStudentsVisible
        {
            get { return _isClearStudentsVisible; }
            set { _isClearStudentsVisible = value; NotifyPropertyChanged("isClearStudentsVisible"); }
        }
        public bool isAddEquipmentItemsButtonVisible
        {
            get { return _isAddEquipmentItemsButtonVisible; }
            set { _isAddEquipmentItemsButtonVisible = value; NotifyPropertyChanged("isAddEquipmentItemsButtonVisible"); }
        }
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    if (dbVersion.ToString() == "0") { MessageBox.Show("Database must have a version. Please contact FreedPhoto."); System.Diagnostics.Process.GetCurrentProcess().Kill(); }
        ...
        private bool checkDBConnection()
        {
            ...
            string tempConnectionString = @"Data Source=fpsql\sqlexpress,1522;Initial Catalog=photoforce4;User ID=sa;Password=scanjet88";
        ...
        public void setAllButtonsVisibility()
        {
            ...
            isRenameSourceImagesVisible = false; isAddCollectionButtonVisible = false; isAddEquipmentItemsButtonVisible = false; isClearStudentsVisible = false;
            isDuplicatePhotoShootsButtonVisible = false;
